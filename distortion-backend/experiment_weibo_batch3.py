...
CANDIDATE_ACCOUNTS = [
    # ── 财经/股市（高失真预期）────────────────────────────────────────────
    {"handle": "weibo/1875034341", "name": "华尔街见闻",    "category": "finance_cn", "expected": "high"},
    {"handle": "weibo/1664176597", "name": "证券时报",      "category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/1905628462", "name": "上海证券报",    "category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/1076684233", "name": "中国证券网",    "category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/1638782947", "name": "新浪财经",      "category": "finance_cn", "expected": "high"},
    {"handle": "weibo/1974561081", "name": "网易财经",      "category": "finance_cn", "expected": "high"},
    {"handle": "weibo/6279793619", "name": "腾讯财经",      "category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/1801487174", "name": "东方财富网",    "category": "finance_cn", "expected": "high"},
    {"handle": "weibo/1684012053", "name": "财经杂志",      "category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/1651428902", "name": "21世纪经济报道","category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/1926909715", "name": "第一财经日报",  "category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/1771806172", "name": "证券中国网",    "category": "finance_cn", "expected": "high"},
    # ── 科技媒体（中等失真预期）──────────────────────────────────────────
    {"handle": "weibo/3515639462", "name": "科技日报",      "category": "tech_cn",    "expected": "low"},
    {"handle": "weibo/1747383115", "name": "ZOL中关村在线", "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1649597805", "name": "电脑报",        "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1826017320", "name": "IT之家",        "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1659643027", "name": "快科技官方",    "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/5061312402", "name": "雷科技",        "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1726544024", "name": "数字尾巴",      "category": "tech_cn",    "expected": "low"},
    {"handle": "weibo/2437314751", "name": "爱范儿ifanr",   "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1914010467", "name": "少数派sspai",   "category": "tech_cn",    "expected": "low"},
    # ── AI/机器学习媒体（中等失真预期）───────────────────────────────────
    {"handle": "weibo/3996876140", "name": "机器之心",      "category": "ai_ml_cn",   "expected": "moderate"},
    {"handle": "weibo/6105753431", "name": "量子位",        "category": "ai_ml_cn",   "expected": "high"},
    {"handle": "weibo/5703921756", "name": "新智元",        "category": "ai_ml_cn",   "expected": "high"},
    {"handle": "weibo/5213469505", "name": "智东西",        "category": "ai_ml_cn",   "expected": "moderate"},
    {"handle": "weibo/1735559201", "name": "极客公园",      "category": "ai_ml_cn",   "expected": "moderate"},
    # ── 新闻媒体（低失真预期）────────────────────────────────────────────
    {"handle": "weibo/2810373291", "name": "新华网",        "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/1663072851", "name": "中国日报",      "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/2375086267", "name": "参考消息",      "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/1887344341", "name": "观察者网",      "category": "media_cn",   "expected": "moderate"},
    {"handle": "weibo/5182171545", "name": "界面新闻",      "category": "media_cn",   "expected": "moderate"},
    {"handle": "weibo/1641561812", "name": "经济观察报",    "category": "media_cn",   "expected": "moderate"},
    {"handle": "weibo/1644489953", "name": "南方都市报",    "category": "media_cn",   "expected": "moderate"},
    # ── 科学/地理/文化（低失真预期）──────────────────────────────────────
    {"handle": "weibo/1195054531", "name": "博物杂志",      "category": "science_cn", "expected": "low"},
    {"handle": "weibo/1222135407", "name": "中国国家地理",  "category": "science_cn", "expected": "low"},
    {"handle": "weibo/2210496261", "name": "星球研究所",    "category": "science_cn", "expected": "low"},
    {"handle": "weibo/7492203886", "name": "九行Travelist", "category": "culture_cn", "expected": "low"},
    {"handle": "weibo/5135808743", "name": "一条",          "category": "culture_cn", "expected": "low"},
    {"handle": "weibo/1518966617", "name": "时尚COSMO",     "category": "culture_cn", "expected": "moderate"},
    # ── 体育（中等失真预期）──────────────────────────────────────────────
    {"handle": "weibo/2018499075", "name": "直播吧",        "category": "sports_cn",  "expected": "moderate"},
    {"handle": "weibo/1716376363", "name": "足球报",        "category": "sports_cn",  "expected": "moderate"},
    {"handle": "weibo/1800991937", "name": "CSL中超联赛",   "category": "sports_cn",  "expected": "moderate"},
    {"handle": "weibo/2428962854", "name": "中国足协",      "category": "sports_cn",  "expected": "low"},
    {"handle": "weibo/2993049293", "name": "央视体育",      "category": "sports_cn",  "expected": "low"},
    {"handle": "weibo/7103510112", "name": "中国篮球之队",  "category": "sports_cn",  "expected": "low"},
]
