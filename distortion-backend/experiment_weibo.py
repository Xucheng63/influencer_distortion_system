...
CANDIDATE_ACCOUNTS = [
    ...
    {"handle": "weibo/2656274875", "name": "新华社",     "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/1974576991", "name": "中国新闻网", "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/1497441814", "name": "第一财经",   "category": "finance_cn", "expected": "low"},
    {"handle": "weibo/1699432410", "name": "21财经",     "category": "finance_cn", "expected": "low"},
    {"handle": "weibo/2145291155", "name": "极客公园",   "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1266321801", "name": "阿里巴巴",   "category": "tech_cn",    "expected": "low"},
    {"handle": "weibo/1742987497", "name": "腾讯",       "category": "tech_cn",    "expected": "low"},
    {"handle": "weibo/1618051664", "name": "丁香医生",   "category": "health_cn",  "expected": "low"},
    {"handle": "weibo/1669879400", "name": "何炅",       "category": "culture_cn", "expected": "moderate"},
    {"handle": "weibo/1887344341", "name": "懒熊体育",   "category": "sports_cn",  "expected": "moderate"},
    # ── 新增账号（已验证UID真实）─────────────────────────────────────────────
    # 官方媒体
    {"handle": "weibo/2279340750", "name": "央视新闻",   "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/5765961631", "name": "环球时报",   "category": "media_cn",   "expected": "moderate"},
    {"handle": "weibo/2087491987", "name": "澎湃新闻",   "category": "media_cn",   "expected": "moderate"},
    {"handle": "weibo/1974212047", "name": "每日经济新闻","category": "finance_cn", "expected": "moderate"},
    {"handle": "weibo/3683746177", "name": "财联社",     "category": "finance_cn", "expected": "moderate"},
    # 科技媒体
    {"handle": "weibo/1904210410", "name": "36氪",       "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/5748218349", "name": "虎嗅网",     "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1400781335", "name": "钛媒体",     "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/5616937097", "name": "爱范儿",     "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1737858472", "name": "百度",       "category": "tech_cn",    "expected": "low"},
    # 财经大V
    {"handle": "weibo/1651428902", "name": "吴晓波",     "category": "finance_cn", "expected": "high"},
    {"handle": "weibo/1461671105", "name": "李大霄",     "category": "finance_cn", "expected": "high"},
    {"handle": "weibo/1880491925", "name": "但斌",       "category": "finance_cn", "expected": "high"},
    {"handle": "weibo/1642909335", "name": "水皮",       "category": "finance_cn", "expected": "high"},
    # 科技大V
    {"handle": "weibo/1615524462", "name": "阑夕",       "category": "tech_cn",    "expected": "moderate"},
    {"handle": "weibo/1160452625", "name": "月光博客",   "category": "tech_cn",    "expected": "low"},
    {"handle": "weibo/2086203512", "name": "keso",       "category": "tech_cn",    "expected": "low"},
    {"handle": "weibo/1195133712", "name": "和菜头",     "category": "culture_cn", "expected": "low"},
    # 文化大V
    {"handle": "weibo/1191258123", "name": "罗振宇",     "category": "culture_cn", "expected": "high"},
    {"handle": "weibo/2404105591", "name": "作业本",     "category": "culture_cn", "expected": "moderate"},
    {"handle": "weibo/1227368500", "name": "牛文文",     "category": "startup_cn", "expected": "moderate"},
    # 健康/科学
    {"handle": "weibo/5661792345", "name": "果壳网",     "category": "science_cn", "expected": "low"},
    {"handle": "weibo/2246477555", "name": "科普中国",   "category": "science_cn", "expected": "low"},
    {"handle": "weibo/3183407691", "name": "丁香园",     "category": "health_cn",  "expected": "low"},
    # 娱乐明星
    {"handle": "weibo/1195130435", "name": "谢娜",       "category": "culture_cn", "expected": "high"},
    {"handle": "weibo/1040566474", "name": "杨幂",       "category": "culture_cn", "expected": "high"},
    {"handle": "weibo/5361490733", "name": "肖战",       "category": "culture_cn", "expected": "high"},
    {"handle": "weibo/1843202614", "name": "薛蛮子",     "category": "politics_cn","expected": "high"},
    # 体育
    {"handle": "weibo/1042099714", "name": "中国之队",   "category": "sports_cn",  "expected": "moderate"},
    {"handle": "weibo/1751882571", "name": "NBA中国",    "category": "sports_cn",  "expected": "moderate"},
    {"handle": "weibo/1644313940", "name": "体坛周报",   "category": "sports_cn",  "expected": "moderate"},
    {"handle": "weibo/1198491834", "name": "苏炳添",     "category": "sports_cn",  "expected": "low"},
    # 新增知名媒体
    {"handle": "weibo/2058093813", "name": "南方周末",   "category": "media_cn",   "expected": "moderate"},
    {"handle": "weibo/1893801487", "name": "财新网",     "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/1642909335", "name": "冰点周刊",   "category": "media_cn",   "expected": "low"},
    {"handle": "weibo/1785255691", "name": "人物杂志",   "category": "culture_cn", "expected": "moderate"},
    {"handle": "weibo/1710604046", "name": "三联生活周刊","category": "culture_cn", "expected": "low"},
    {"handle": "weibo/5616937097", "name": "少数派",     "category": "tech_cn",    "expected": "low"},
    {"handle": "weibo/2351484473", "name": "新京报",     "category": "media_cn",   "expected": "moderate"},
    {"handle": "weibo/1497441814", "name": "第一财经视频","category": "finance_cn", "expected": "moderate"},
]
# ── Weibo 抓取（直接调用，不经过后端）───────────────────────────────────────
