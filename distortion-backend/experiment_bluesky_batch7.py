...
CANDIDATE_ACCOUNTS = [
    # 批次7验证通过的11个账号
    {"handle": "helaine.bsky.social",    "category": "finance",  "expected": "moderate"},
    {"handle": "lemonde.fr",             "category": "media",    "expected": "low"},
    {"handle": "theguardian.com",        "category": "media",    "expected": "low"},
    {"handle": "economist.com",          "category": "media",    "expected": "low"},
    {"handle": "time.com",               "category": "media",    "expected": "moderate"},
    {"handle": "davidfrum.bsky.social",  "category": "politics", "expected": "high"},
    {"handle": "ezraklein.bsky.social",  "category": "politics", "expected": "moderate"},
    {"handle": "npr.org",                "category": "media",    "expected": "low"},
    {"handle": "theatlantic.com",        "category": "media",    "expected": "moderate"},
    {"handle": "wired.com",              "category": "tech",     "expected": "moderate"},
    {"handle": "thenation.com",          "category": "politics", "expected": "high"},
]
