...
CANDIDATE_ACCOUNTS = [
    # ── 政治/社会 — 百万级关注，高度活跃 ─────────────────────────────────────
    {"handle": "aoc.bsky.social",           "category": "politics",   "expected": "high"},
    {"handle": "markcuban.bsky.social",     "category": "finance",    "expected": "high"},
    {"handle": "georgetakei.bsky.social",   "category": "culture",    "expected": "moderate"},
    {"handle": "markhamill.bsky.social",    "category": "culture",    "expected": "moderate"},
    {"handle": "stephenking.bsky.social",   "category": "culture",    "expected": "moderate"},
    {"handle": "rachelmaddow.bsky.social",  "category": "media",      "expected": "moderate"},
    # ── 科技/AI — 真实活跃账号 ────────────────────────────────────────────────
    {"handle": "pfrazee.com",               "category": "tech",       "expected": "low"},
    {"handle": "jay.bsky.team",             "category": "tech",       "expected": "low"},
    {"handle": "karaswisher.bsky.social",   "category": "tech_media", "expected": "high"},
    {"handle": "caseynewton.bsky.social",   "category": "tech_media", "expected": "moderate"},
    {"handle": "davewiner.bsky.social",     "category": "tech",       "expected": "moderate"},
    {"handle": "gruber.bsky.social",        "category": "tech",       "expected": "low"},
    {"handle": "mathewi.bsky.social",       "category": "tech_media", "expected": "moderate"},
    {"handle": "benedictevans.bsky.social", "category": "tech",       "expected": "low"},
    # ── 媒体/新闻 ─────────────────────────────────────────────────────────────
    {"handle": "nytimes.com",               "category": "media",      "expected": "moderate"},
    {"handle": "theguardian.com",           "category": "media",      "expected": "moderate"},
    {"handle": "washingtonpost.com",        "category": "media",      "expected": "moderate"},
    {"handle": "theatlantic.com",           "category": "media",      "expected": "moderate"},
    {"handle": "propublica.bsky.social",    "category": "media",      "expected": "low"},
    {"handle": "404media.co",               "category": "tech_media", "expected": "moderate"},
    # ── 科学/健康 ─────────────────────────────────────────────────────────────
    {"handle": "erictopol.bsky.social",     "category": "health",     "expected": "low"},
    {"handle": "sciam.bsky.social",         "category": "science",    "expected": "low"},
    {"handle": "zeynep.bsky.social",        "category": "science",    "expected": "moderate"},
    {"handle": "drleanawen.bsky.social",    "category": "health",     "expected": "moderate"},
    {"handle": "billmckibben.bsky.social",  "category": "science",    "expected": "moderate"},
    # ── 文化/娱乐 ─────────────────────────────────────────────────────────────
    {"handle": "austinkleon.bsky.social",   "category": "culture",    "expected": "low"},
    {"handle": "manyfesto.bsky.social",     "category": "lifestyle",  "expected": "moderate"},
    {"handle": "neilhimself.bsky.social",   "category": "culture",    "expected": "low"},
    {"handle": "pattonoswalt.bsky.social",  "category": "culture",    "expected": "moderate"},
    {"handle": "kenjennings.bsky.social",   "category": "culture",    "expected": "low"},
    # ── AI/研究 ───────────────────────────────────────────────────────────────
    {"handle": "goodfellow.bsky.social",    "category": "ai_ml",      "expected": "low"},
    {"handle": "emilybender.bsky.social",   "category": "ai_ml",      "expected": "low"},
    {"handle": "timnitgebru.bsky.social",   "category": "ai_ml",      "expected": "moderate"},
    {"handle": "aisnakeoil.bsky.social",    "category": "ai_ml",      "expected": "low"},
    {"handle": "ylecun.bsky.social",        "category": "ai_ml",      "expected": "moderate"},
    # ── 财经/政治 ─────────────────────────────────────────────────────────────
    {"handle": "natesilver.bsky.social",    "category": "politics",   "expected": "moderate"},
    {"handle": "davidfrum.bsky.social",     "category": "politics",   "expected": "high"},
    {"handle": "ezraklein.bsky.social",     "category": "media",      "expected": "moderate"},
    {"handle": "nntaleb.bsky.social",       "category": "finance",    "expected": "high"},
    {"handle": "pkedrosky.bsky.social",     "category": "finance",    "expected": "moderate"},
    # ── 新闻记者/媒体评论 ─────────────────────────────────────────────────────
    {"handle": "jayrosen.bsky.social",      "category": "media",      "expected": "low"},
    {"handle": "davepell.bsky.social",      "category": "media",      "expected": "moderate"},
    {"handle": "jeffjarvis.bsky.social",    "category": "media",      "expected": "moderate"},
    {"handle": "dangillmor.bsky.social",    "category": "media",      "expected": "low"},
    {"handle": "ericgarland.bsky.social",   "category": "politics",   "expected": "high"},
    {"handle": "robinsonmeyer.bsky.social", "category": "science",    "expected": "low"},
    {"handle": "pwire.bsky.social",         "category": "media",      "expected": "moderate"},
    {"handle": "mathewi.bsky.social",       "category": "media",      "expected": "moderate"},
    {"handle": "katiecouric.bsky.social",   "category": "media",      "expected": "moderate"},
    {"handle": "tomTomorrow.bsky.social",   "category": "culture",    "expected": "moderate"},
    {"handle": "markcuban.bsky.social",     "category": "finance",    "expected": "high"},
]
