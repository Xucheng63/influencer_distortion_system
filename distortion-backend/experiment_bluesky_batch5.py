...
CANDIDATE_ACCOUNTS = [
    ...
    {"handle": "mehdihasan.bsky.social",     "category": "media",     "expected": "high"},
    {"handle": "juddlegum.bsky.social",      "category": "media",     "expected": "high"},
    {"handle": "tomnicholsoc.bsky.social",   "category": "politics",  "expected": "high"},
    {"handle": "greggsargent.bsky.social",   "category": "media",     "expected": "high"},
    {"handle": "charliewarzel.bsky.social",  "category": "tech_media","expected": "moderate"},
    {"handle": "oliverdarcy.bsky.social",    "category": "media",     "expected": "moderate"},
    {"handle": "donlemon.bsky.social",       "category": "media",     "expected": "moderate"},
    {"handle": "joyreid.bsky.social",        "category": "media",     "expected": "high"},
    # ── 政治/政策 ─────────────────────────────────────────────────────────────
    {"handle": "keitholbermann.bsky.social", "category": "politics",  "expected": "high"},
    {"handle": "adamschiff.bsky.social",     "category": "politics",  "expected": "high"},
    {"handle": "ewarren.bsky.social",        "category": "politics",  "expected": "high"},
    {"handle": "berniesanders.bsky.social",  "category": "politics",  "expected": "high"},
    {"handle": "repraskin.bsky.social",      "category": "politics",  "expected": "moderate"},
    # ── 科技媒体 ──────────────────────────────────────────────────────────────
    {"handle": "taylorlorenz.bsky.social",   "category": "tech_media","expected": "high"},
    {"handle": "edzitron.bsky.social",       "category": "tech_media","expected": "high"},
    {"handle": "parismarx.bsky.social",      "category": "tech_media","expected": "high"},
    {"handle": "katienotopoulos.bsky.social","category": "tech_media","expected": "moderate"},
    {"handle": "charliestross.bsky.social",  "category": "tech",      "expected": "moderate"},
    # ── 文化/娱乐 ─────────────────────────────────────────────────────────────
    {"handle": "weirdal.bsky.social",        "category": "culture",   "expected": "moderate"},
    {"handle": "jamieleecurtis.bsky.social", "category": "culture",   "expected": "moderate"},
    {"handle": "quintabrunson.bsky.social",  "category": "culture",   "expected": "low"},
    {"handle": "johncusack.bsky.social",     "category": "culture",   "expected": "high"},
    {"handle": "benstiller.bsky.social",     "category": "culture",   "expected": "low"},
    # ── 财经 ──────────────────────────────────────────────────────────────────
    {"handle": "paulkrugman.bsky.social",    "category": "finance",   "expected": "moderate"},
    ...
    # ── 科学/环境 ─────────────────────────────────────────────────────────────
    {"handle": "michaelmann.bsky.social",    "category": "science",   "expected": "high"},
    {"handle": "kathyhyde.bsky.social",      "category": "science",   "expected": "low"},
]
