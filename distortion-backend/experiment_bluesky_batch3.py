...
CANDIDATE_ACCOUNTS = [
    # ── 政治/社会 — 已知在 Bluesky 高度活跃 ──────────────────────────────────
    {"handle": "anneapplebaum.bsky.social",  "category": "politics",   "expected": "high"},
    {"handle": "adamkinzinger.bsky.social",  "category": "politics",   "expected": "high"},
    {"handle": "keiththebaldwin.bsky.social","category": "politics",   "expected": "high"},
    {"handle": "brianstelter.bsky.social",   "category": "media",      "expected": "moderate"},
    {"handle": "joelpaul.bsky.social",       "category": "politics",   "expected": "moderate"},
    # ── 媒体/新闻机构 — 有大量帖子的 ─────────────────────────────────────────
    {"handle": "axios.bsky.social",          "category": "media",      "expected": "moderate"},
    {"handle": "slate.bsky.social",          "category": "media",      "expected": "moderate"},
    {"handle": "vox.bsky.social",            "category": "media",      "expected": "moderate"},
    {"handle": "theintercept.bsky.social",   "category": "media",      "expected": "moderate"},
    {"handle": "motherjones.bsky.social",    "category": "media",      "expected": "moderate"},
    {"handle": "thenation.bsky.social",      "category": "media",      "expected": "moderate"},
    {"handle": "newrepublic.bsky.social",    "category": "media",      "expected": "moderate"},
    {"handle": "foreignpolicy.bsky.social",  "category": "media",      "expected": "low"},
    {"handle": "foreignaffairs.bsky.social", "category": "media",      "expected": "low"},
    {"handle": "quanta.bsky.social",         "category": "science",    "expected": "low"},
    # ── 科技 ──────────────────────────────────────────────────────────────────
    {"handle": "corydoctorow.bsky.social",   "category": "tech",       "expected": "high"},
    {"handle": "simonw.bsky.social",         "category": "tech",       "expected": "low"},
    {"handle": "glyph.bsky.social",          "category": "tech",       "expected": "low"},
    {"handle": "danluu.bsky.social",         "category": "tech",       "expected": "low"},
    {"handle": "swiftonsecurity.bsky.social","category": "tech",       "expected": "moderate"},
    # ── 科学/环境 ─────────────────────────────────────────────────────────────
    {"handle": "billmckibben.bsky.social",   "category": "science",    "expected": "moderate"},
    {"handle": "sciencefriday.bsky.social",  "category": "science",    "expected": "low"},
    {"handle": "michaelemanuel.bsky.social", "category": "science",    "expected": "low"},
    {"handle": "noaanews.bsky.social",       "category": "science",    "expected": "low"},
    {"handle": "climatepower.bsky.social",   "category": "science",    "expected": "moderate"},
    # ── 文化/娱乐 ─────────────────────────────────────────────────────────────
    {"handle": "wil.bsky.social",            "category": "culture",    "expected": "moderate"},
    {"handle": "amandapalmer.bsky.social",   "category": "culture",    "expected": "moderate"},
    {"handle": "jonathancoulton.bsky.social","category": "culture",    "expected": "low"},
    {"handle": "patrickrhone.bsky.social",   "category": "culture",    "expected": "low"},
    {"handle": "ruminatemagazine.bsky.social","category": "culture",   "expected": "low"},
    # ── 财经/商业 ─────────────────────────────────────────────────────────────
    {"handle": "felixsalmon.bsky.social",    "category": "finance",    "expected": "moderate"},
    {"handle": "calculatedrisk.bsky.social", "category": "finance",    "expected": "low"},
    {"handle": "therecount.bsky.social",     "category": "media",      "expected": "moderate"},
    {"handle": "semafor.bsky.social",        "category": "media",      "expected": "moderate"},
    {"handle": "marketwatch.bsky.social",    "category": "finance",    "expected": "moderate"},
    # ── 健康/医疗 ─────────────────────────────────────────────────────────────
    {"handle": "ashishkjha.bsky.social",     "category": "health",     "expected": "low"},
    {"handle": "lucymcgowan.bsky.social",    "category": "health",     "expected": "low"},
    {"handle": "zackaryberger.bsky.social",  "category": "health",     "expected": "low"},
    {"handle": "katesnow.bsky.social",       "category": "health",     "expected": "moderate"},
    {"handle": "vinay.bsky.social",          "category": "health",     "expected": "high"},
    # ── AI 研究者 ─────────────────────────────────────────────────────────────
    {"handle": "mmitchell.bsky.social",      "category": "ai_ml",      "expected": "moderate"},
    {"handle": "fchollet.bsky.social",       "category": "ai_ml",      "expected": "low"},
    {"handle": "seb.bsky.social",            "category": "ai_ml",      "expected": "low"},
    {"handle": "dair.bsky.social",           "category": "ai_ml",      "expected": "moderate"},
    {"handle": "weights.bsky.social",        "category": "ai_ml",      "expected": "moderate"},
    # ── 国际媒体 ──────────────────────────────────────────────────────────────
    {"handle": "bbcnews.bsky.social",        "category": "media",      "expected": "low"},
    {"handle": "theeconomist.bsky.social",   "category": "finance",    "expected": "low"},
    {"handle": "aljazeera.bsky.social",      "category": "media",      "expected": "moderate"},
    {"handle": "derspiegel.bsky.social",     "category": "media",      "expected": "moderate"},
    {"handle": "lemonde.bsky.social",        "category": "media",      "expected": "low"},
]
# ── HTTP 工具 ─────────────────────────────────────────────────────────────────
